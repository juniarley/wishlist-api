...
import com.wishlist.wishlistapi.domain.exception.*;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public static final String MSG_ERRO_GENERIC
    ...
    public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
        ...
        String detail = MSG_ERRO_GENERIC;
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
        ...
        String detail = String.format("OThe URL parameter '%s' was given the value '%s'," +
                                      "which is of an invalid type. Correct and enter a value compatible with type %s. %s.",
    ...
    private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex,
        ...
        ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
        String detail = String.format("The property '%s' was given the value '%s', " +
    ...
    @ExceptionHandler(MaximumAmountProductWishlistException.class)
    public ResponseEntity<?> handleMaximumAmountProductWishlist(MaximumAmountProductWishlistException ex,
                                                  WebRequest request) {
    ...
    @ExceptionHandler(ExistingProductWishlistException.class)
    public ResponseEntity<?> handleMExistingProductWishlistException(ExistingProductWishlistException ex,
                                                                WebRequest request) {
